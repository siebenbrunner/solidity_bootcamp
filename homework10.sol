...
import "@openzeppelin/contracts/token/ERC20/ERC20.sol"; // specify template version
...
constructor(string memory name_, string memory symbol_, address _administrator) ERC20(name_,symbol_) { // call parent constructor
